...
@bot.channel_post_handler(content_types=['text', 'photo', 'audio', 'video', 'document', 'sticker', 'video_note', 'voice', 'location', 'contact'])
...
@app.route('/')
def home():
    return "Reaction API is active !! ~ AP BOTS [ @DEV_PIYUSH | @PYANU ]"
